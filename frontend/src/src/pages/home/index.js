        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-7">
              ...
              <a href="/map" className="btn btn-explore" style={{ display: "block", textAlign: "center", width: 200 }}>
                Explore
              </a>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-7">
              ...
              <a href="/chat" className="btn btn-success" style={{ display: "block", textAlign: "center", width: 200 }}>
                Click
              </a>
            </div>
            <div className="col-lg-5">
